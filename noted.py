...
try :
    ...
    if os.path.isfile("/home/" + str(os.getlogin()) + "/.notednotes") == False and os.path.isfile("/home/" + str(os.getlogin()) + "/.notednotes.cpt") == False:
        ...
        print(Fore.BLUE + "Set a password for your notes")
        os.system('touch /home/' + str(os.getlogin()) + '/.notednotes && /bin/ccrypt -e /home/' + str(os.getlogin()) + "/.notednotes")
...
if str(option) == "view":
    os.system('/bin/ccrypt -d /home/' + str(os.getlogin()) + '/.notednotes.cpt')
            ...
            if note2search4 in str(s1[i]):
                ...
                for x in range(i + 1, len(s1)):
                    if str(s1[x]) != "~~~~~~~~~~~~~~~~NOTE~~~~~~END~~~~~~~~~~~~~~~~~":
                        ...
                        print(str(s1[x]))
                        print(Fore.BLUE + "Enter your password for your notes")
                        os.system('/bin/ccrypt -e /home/' + str(os.getlogin()) + '/.notednotes')
                        quit()
